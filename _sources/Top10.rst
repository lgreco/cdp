...
As it takes a while for a paper to become *seminal*, the list of papers above does not extend much beyond the mid-2010s. Nevertheless, there are significant publications in CS that appear every year. These can be found on `arXiv <https://arxiv.org/>`_, the open-access archive for most things STEM.
