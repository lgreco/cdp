...
Know how to perform simple array operations -- even though they can be performed easily by using the ``Arrays`` class. You should be able to write a few lines of code to do the following, from srcatch (without the ``Arrays`` class):
