...
For courses in which I am the sole instructor, I employ an evaluation technique known as **ungrading.**  When I participate in a team-taught course, I following the team's grading policy -- in this case, the policy is posted on Sakai.
...
Everyone is expected to miss a class meeting now and then. Missing more than 10% of the class meetings in a term will have a serious impact on your final grade. Missing more, will have a detrimental effect. Coming to class five 5-10 or more minutes late counts as a missed class.
...
The University's policy for `Honoring Student Religious Observances <https://www.luc.edu/academicaffairs/stories/archive/honoringstudentreligiousobservances.shtml>`__ is hereby incorporate by reference.

Attendance is recorded at random intervals throughout the term.
...
I am fully committed to supporting students with approved accommodations by the University's Student Accessibility Center. The University's policies and guidelines regarding such accommodations are `incorporated by reference <https://www.luc.edu/sac/faculty/>`__ to this course syllabus.


Information about Title IX
===========================================

As a faculty member, I am mandate reporter any time there is reasonable cause to believe that a student known to me in my official capacity may be abused or neglected. This includes instances of sexual misconduct. Therefore, the following University policies and language are `incorporated by reference <https://www.luc.edu/equity/otherresources/resourcesforfacultystaff/syllabuslanguage/>`__ to this course syllabus:
