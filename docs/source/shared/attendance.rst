...
The university classifies certain absences as excused (see `Undergraduate Attendance Policy <https://catalog.luc.edu/academic-standards-regulations/undergraduate/>`_). These excused absences do not count as absences in the class. I always appreciate a heads-up if you’re unable to make it to class—it’s helpful and courteous. Please keep in mind, though, that letting me know does not change how an absence is classified under the policy.
